...
MATRIX_FILE = "mesenchymal_pb_matrix_tacco_ensemble.tsv"
META_FILE   = "mesenchymal_pb_meta_tacco_ensemble.tsv"
...
PHASES_TO_INCLUDE = ["Menstrual", "Proliferative", "Secretory"]

if len(PHASES_TO_INCLUDE) == 4:
    OUTPUT_DIR = "glm_outputs_tacco"
else:
    OUTPUT_DIR = "glm_outputs_tacco_" + "_".join(PHASES_TO_INCLUDE)
...
FDR_THRESH    = 0.05
N_TOP         = 10
MIN_CPM_RANGE = 3.0   # minimum dynamic range in log2-CPM units for plot gene selection
